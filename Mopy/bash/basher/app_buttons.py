...
class StatusBar_Button(ItemLink):
    ...
    def IsPresent(self):
        ...
        PITA - I provided this base class method to early filter out non
        existent buttons."""
        return True

    def GetBitmapButton(self, window, style, **kwdargs):
        """Create and return gui button - you must define imageKey - WIP overrides"""
        btm_image = kwdargs.pop('image', None) or balt.images[self.imageKey %
        ...
        self.gButton = bitmapButton(window, btm_image, style=style,
